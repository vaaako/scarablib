...
void Camera::zoom(const float speed, const Camera::Zoom zoom_dir) noexcept {
...
void Camera::set_rotation(const float yaw, const float pitch) noexcept {
...
std::string_view Camera::get_cardinal_direction(const float yaw) {
...
void Camera::update_proj_matrix() noexcept {
